...
from klasy_api_obsluga.CurrencyRates import CurrencyRates
from klasy_api_obsluga.GoldPrices import GoldPrices
from klasy_api_obsluga.HistoricalData import HistoricalData
